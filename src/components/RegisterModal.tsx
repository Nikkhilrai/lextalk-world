                                    ...
                                    >
                                        ...
                                        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-2">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="space-y-3 pl-4">
                                                    {['Dubai UAE, Sep 9-10 2026', 'Mumbai India, Dec 10-11 2026', 'Riyadh KSA, Jan 26 2027', 'Indonesia, March 5 2027', 'Delhi India, July 2027'].map((option) => (
                                        ...
                                        <motion.div variants={itemVariants} className="flex justify-center pt-6">
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className="group relative px-12 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-base font-bold rounded-full overflow-hidden shadow-lg hover:shadow-amber-500/30 hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                                            >
