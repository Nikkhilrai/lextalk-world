...
export function IndonesiaGlobalLegacy() {
    return (
        <section className="relative bg-[#faf9f6] overflow-hidden py-20 md:py-28">
            {/* Top separator */}
            <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-orange-300/50 to-transparent" />

            {/* Faint warm glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-64 bg-orange-100/40 blur-[80px] pointer-events-none" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end mb-14 md:mb-16">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <span className="text-xs font-semibold text-orange-600 uppercase tracking-[0.3em]">A Global Journey</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 leading-[1.15]">
                                Building on a{" "}
                                <span className="text-orange-500">Global Legacy</span>
                            </h2>
                        </motion.div>
                        ...
                        >
                            <div className="border-l-2 border-orange-400 pl-6">
                                ...
                                <p className="text-slate-800 font-medium text-sm italic">
                                    The Jakarta Conference extends this legacy — Southeast Asia&apos;s gateway into the global LexTalk World ecosystem.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8">
                                    <div className="flex items-center gap-2 mb-3">
                                        <div className="w-6 h-px bg-orange-400 group-hover:w-10 transition-all duration-500" />
                                    ...
                                    <div className="mt-4 flex items-center gap-2 text-white/60 text-xs font-medium uppercase tracking-tighter opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 delay-100">
                                        Visit Dubai Event <span className="text-orange-500">→</span>
                                    </div>
                                </div>
                            </Link>
                        </motion.div>
                            ...
                            {cities.slice(1).map((city, i) => (
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-5">
                                        <span className="text-orange-400 text-[10px] font-semibold uppercase tracking-widest block mb-1">
                                            {city.label}
                                        </span>
