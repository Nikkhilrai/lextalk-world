...
// Same attendee personas as the other LexTalk World editions, framed for Jakarta
const attendees = [
    {
    ...
    },
    {
        ...
        tag: "Government bodies, regulators, and institutional leaders shaping legal and policy frameworks across Indonesia.",
...
const stats = [
    ...
    { value: "80%", label: "Senior Level" },
    { value: "20+", label: "Industries" },
];

export function IndonesiaWhoYouWillMeet() {
    return (
        <section className="relative bg-[#0a1a15] overflow-hidden py-24 md:py-32">
            {/* Background textures */}
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 right-1/3 w-[600px] h-[600px] bg-emerald-500/5 rounded-full blur-[120px]" />
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10 mb-16 md:mb-20">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <span className="text-xs font-semibold text-orange-400 uppercase tracking-[0.3em]">The Audience</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-[1.1]">
                                ...
                                <span className="text-orange-400 relative inline-block">
                                    Network With
                                    <div className="absolute -bottom-2 left-0 w-full h-1 bg-orange-400/30 rounded-full blur-[2px]"></div>
                                </span>
                            </h2>
                            <p className="mt-6 text-slate-400 text-sm md:text-lg font-light leading-relaxed">
                                LexTalk World Jakarta brings together a curated group of senior legal leaders, specialists, and decision-makers across the global legal and regulatory ecosystem.
                            </p>
                        </motion.div>
                    ...
                    >
                        <p className="text-slate-400 text-sm md:text-base font-light max-w-3xl mx-auto leading-relaxed px-4">
                            ...
                            <span className="text-orange-400 font-medium">industry relevance</span> across Southeast Asia&apos;s legal community.
                        </p>
                    </motion.div>
