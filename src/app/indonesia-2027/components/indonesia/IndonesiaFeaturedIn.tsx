        ...
        <section className="py-12 bg-slate-50 relative overflow-hidden">
            <div className="container mx-auto px-4 mb-8">
                <div className="flex items-center justify-center gap-4">
                    <div className="h-[1px] w-8 sm:w-16 bg-gradient-to-r from-transparent to-orange-500/50"></div>
                    <h2 className="text-[10px] sm:text-xs font-bold text-slate-400 uppercase tracking-[0.4em] whitespace-nowrap">Supported By</h2>
                    <div className="h-[1px] w-8 sm:w-16 bg-gradient-to-l from-transparent to-orange-500/50"></div>
                </div>
            </div>
            ...
            <div className="relative w-full max-w-[100vw] overflow-hidden group">
                ...
                <div className="flex animate-marquee-indonesia group-hover:[animation-play-state:paused] items-center">
            ...
            <style jsx global>{`
                ...
                .animate-marquee-indonesia {
                    display: flex;
                    width: max-content;
                    animation: marquee-indonesia 40s linear infinite;
                }
            `}</style>
        </section>
    );
