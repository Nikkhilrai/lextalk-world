...
export function IndonesiaMoreThanAConference() {
            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-8 pt-24 md:pt-32 pb-16 md:pb-20">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <span className="text-xs font-semibold text-orange-600 uppercase tracking-[0.4em]">
                            The LexTalk Promise
                        </span>
                        <div className="w-10 h-px bg-orange-500/60" />
                    </motion.div>
                    ...
                    >
                        More Than a{" "}
                        <span className="text-orange-500 italic">Conference</span>
                    </motion.h2>
                    ...
                    <motion.div
                        ...
                        className="w-16 h-0.5 bg-orange-500/30 mx-auto mb-8 origin-center"
                    />
                    ...
                    >
                        <p className="text-xl md:text-2xl text-slate-700 font-light leading-relaxed">
                            LexTalk World Jakarta is not about{" "}
                            <span className="line-through decoration-orange-500/60 text-slate-400">volume</span>{" "}
                            — it is about{" "}
                        ...
                        <p className="text-base md:text-lg text-slate-500 font-light leading-relaxed">
                            ...
                            <span className="text-orange-600 font-medium">future of law in Indonesia and beyond</span>.
                        </p>
                    </motion.div>
                </div>
            </div>
