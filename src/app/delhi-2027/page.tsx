...
export default function Delhi2027Page() {
        ...
        <main className="min-h-screen bg-[#050a15]">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20">
                ...
                <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
                    ...
                    >
                        LexTalk World returns to India&apos;s capital in 2027. We&apos;re finalising the dates, venue, and
                    ...
                    >
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
                            ...
                            <span className="text-slate-300 text-xs font-semibold tracking-wide">July 2027</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
                            <MapPin className="w-3.5 h-3.5 text-amber-500/70" />
                            <span className="text-slate-300 text-xs font-semibold tracking-wide">New Delhi, India</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
                            <Clock className="w-3.5 h-3.5 text-amber-500/70" />
                            <span className="text-slate-300 text-xs font-semibold tracking-wide">Dates to be announced</span>
                        </div>
                    </motion.div>
            ...
            <RegisterModal
                ...
                defaultConference="Delhi India, July 2027"
            />
        </main>
    );
}
