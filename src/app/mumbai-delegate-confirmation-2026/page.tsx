...
function ConfirmationContent() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            a.href = url;
            a.download = `LexTalk-Mumbai-${registration.ticketNumber || "Pass"}.pdf`;
    ...
    if (error || !registration) return (
        <div className="max-w-md mx-auto text-center py-20 px-6">
            ...
            <button onClick={() => router.push("/mumbai-delegate-registration-2026")} className="text-amber-600 font-semibold hover:underline flex items-center justify-center gap-2 mx-auto text-sm">
    ...
    return (
        <div className="container mx-auto px-4 max-w-2xl py-10 md:py-16">
            ...
            >
                {/* Header */}
                <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-[#050a15] px-8 py-10 text-center relative overflow-hidden">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(245,158,11,0.15),transparent)] pointer-events-none" />
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-amber-500/5 rounded-full blur-[80px] pointer-events-none" />
                    <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                    ...
                    <p className="text-slate-400 text-sm max-w-sm mx-auto leading-relaxed">
                        Welcome to LexTalk World Mumbai 2026. Your place among India&apos;s legal elite is secured.
                    </p>
                </div>
                ...
                <div className="p-7 md:p-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <DetailItem icon={Calendar} label="Date" value="Dec 7–8, Monday & Tuesday, 2026" />
                            <DetailItem icon={MapPin} label="Location" value="Radisson Blu Mumbai International Airport" />
                    ...
                    <div className="space-y-3 pt-7 border-t border-slate-100">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-2xl transition-all shadow-lg shadow-amber-500/15 active:scale-[0.98]"
                        >
                            <Download size={20} />
            ...
            <div className="mt-8 text-center">
                <button
                    onClick={() => router.push("/mumbai-2026")}
    ...
    return (
        <div className="flex items-start gap-3">
            ...
            <div>
                ...
                <p className={`font-semibold text-sm ${highlight ? "text-amber-600 font-bold text-base" : "text-slate-900"}`}>{value}</p>
            </div>
        </div>
    );
}

export default function MumbaiConfirmationPage() {
    return (
