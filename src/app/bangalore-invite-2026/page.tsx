                ...
                <div className="container mx-auto px-4 relative z-10 pb-16 pt-8">
                    <div className="max-w-3xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-full mb-6">
                            ...
                            <span className="text-amber-400 text-[10px] font-bold uppercase tracking-[0.2em]">LexTalk World · Bangalore Edition</span>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-5 mt-8 text-sm text-slate-400">
                            <div className="flex items-center gap-2">
                                ...
                                <span>Thursday, June 11, 2026</span>
                            </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div>
                                ...
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    LexTalk World Bangalore 2026 brings together General Counsels, Law Firm Partners, Legal Tech innovators and senior legal professionals for a full day of knowledge, networking and recognition.
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm">
                                ...
                                <p className="text-slate-900 font-semibold text-sm">Radisson Blu Atria Bangalore</p>
                                <p className="text-slate-500 text-xs mt-0.5">1 Palace Road, Bengaluru — 560 001</p>
                            </div>
                        </div>
                                ...
                                <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-10 text-center">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-sm text-slate-600">
                                        <div className="bg-slate-50 rounded-xl p-3 text-left">
                                            ...
                                            <p className="font-semibold text-slate-800">June 11, 2026</p>
                                        </div>
                                        <div className="bg-slate-50 rounded-xl p-3 text-left">
                                            <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Venue</p>
                                            <p className="font-semibold text-slate-800">Radisson Blu Atria, Bangalore</p>
                                        </div>
                                    </div>
                                </div>
                            ) : (
