            ...
            try {
                aboutPage = await (prisma as any).aboutPage.create({
                    data: {
                        ...
                        advisoryBoard: defaultContent.advisoryBoard,
                        pastSpeakers: defaultContent.pastSpeakers,
                        partners: defaultContent.partners,
                        aboutImages: defaultContent.aboutImages,
        ...
        if (!aboutPage) {
            ...
            aboutPage = await (prisma as any).aboutPage.create({
                data: {
                    ...
                    advisoryBoard: body.advisoryBoard || defaultContent.advisoryBoard,
                    pastSpeakers: body.pastSpeakers || defaultContent.pastSpeakers,
                    partners: body.partners || defaultContent.partners,
                    aboutImages: body.aboutImages || defaultContent.aboutImages,
