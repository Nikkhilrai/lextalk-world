      ...
      <section className="relative py-24 sm:py-32 overflow-hidden bg-[#FFFDF8]">
        ...
        <div className="container mx-auto px-5 sm:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
            {[
              { initials: "SS", name: "Sushma Shankar", role: "Vice President Legal", org: "Accenture" },
              ...
              >
                ...
                {"name" in speaker
                  ? <><p className="text-slate-900 font-bold text-sm mb-1 relative z-10">{(speaker as any).name}</p>
                      <p className="text-amber-600 text-[10px] font-bold uppercase tracking-widest mb-1 relative z-10">{speaker.role}</p></>
