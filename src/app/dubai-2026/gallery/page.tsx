...
const PHOTOBUCKET_URL = "https://photobucket.com/share/693fe3e8-c9ed-4e3b-b680-dab525db7982";

const stats = [
    { value: "400+", label: "Delegates" },
    { value: "70+", label: "Speakers" },
    { value: "2 Days", label: "Event" },
    { value: "Sep 9–10", label: "2026" },
];

export default function DubaiGalleryPage() {
    return (
        <main className="min-h-screen bg-[#050a15] flex flex-col">
            <Navbar />

            {/* Page Header */}
            <section className="pt-28 pb-10 px-4 bg-gradient-to-b from-[#0b1220] to-[#050a15] relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-4xl relative z-10">
                    ...
                    >
                        <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-full text-amber-400 text-xs font-bold uppercase tracking-widest mb-5">
                            <Camera size={11} />
                            September 9–10, 2026 · Dubai, UAE
                        </span>
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-3">
                            Event Gallery
                        </h1>
                        <p className="text-slate-400 text-sm">
                            LexTalk World Dubai 2026 · Crowne Plaza, Dubai, UAE
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            {/* Stats */}
            <section className="py-8 border-y border-white/5 bg-[#0b1220]/40">
            ...
            <section className="flex-1 flex items-center justify-center px-4 py-20">
                ...
                >
                    ...
                    <p className="text-slate-400 leading-relaxed mb-10">
                        The full Dubai 2026 photo album is available on Photobucket.
