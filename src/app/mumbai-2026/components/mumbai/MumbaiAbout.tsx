                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                        ...
                        <div className="lg:col-span-7">
                            ...
                            >
                                ...
                                <span className="text-[10px] md:text-xs font-bold text-amber-600 uppercase tracking-[0.4em]">Mumbai 2026</span>
                            </motion.div>
                            ...
                            >
                                <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-slate-900 leading-[1.2]">
                                    LexTalk World <span className="text-amber-600">Conference & Exhibition</span>
                                </h2>
                                <p className="mt-6 text-xl md:text-2xl font-serif text-slate-800 italic leading-snug">
                                    "Where Global Legal Thought Meets India’s Commercial Capital"
                                </p>
                            </motion.div>
                            ...
                            >
                                <p>
                                    Mumbai stands at the crossroads of law, finance, policy, and enterprise. As India’s financial capital and South Asia’s most influential commercial hub, the city plays a defining role in shaping legal discourse across emerging and mature markets alike.
                                </p>

                                <p>
                                    <span className="text-amber-600 font-bold">The LexTalk World Conference & Exhibition</span> – Mumbai brings together senior legal decision-makers, General Counsels, law firm leaders, regulators, and Legal Tech innovators for a high-impact convergence of ideas, insight, and influence.
                                </p>

                                <div className="bg-slate-50 border-l-4 border-amber-500 p-8 rounded-r-2xl">
                                    <p className="text-slate-800 font-medium italic">
                                        Designed as more than a conference, the Mumbai edition serves as a strategic platform for dialogue that reflects the realities of modern legal practice in South Asia while remaining deeply connected to global legal trends.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="lg:col-span-5 space-y-12">
                            ...
                            >
                                ...
                                <div className="absolute top-8 left-8 right-0 bottom-0 border-2 border-amber-100 rounded-2xl -z-10" />
                            </motion.div>

                            {/* Info Grid - Replaces large space with useful visuals */}
                            <div className="grid grid-cols-1 gap-6">
                                {[
                                    { icon: Scale, title: "Strategic Dialogue", text: "Addressing South Asian legal realities." },
