...
export function MumbaiAdvisoryBoard() {
    ...
    // Card position/scale relative to the centered member
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="text-slate-500 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
                        Distinguished legal professionals guiding LexTalk World&apos;s global mission.
                    </p>
                </div>
                    ...
                    <div className="flex justify-center gap-2 mt-4">
                        {boardMembers.map((_, idx) => (
                            <button
                                ...
                                className={`rounded-full transition-all duration-300 ${idx === centerIndex ? "w-8 h-2 bg-amber-500" : "w-2 h-2 bg-slate-300 hover:bg-slate-400"}`}
