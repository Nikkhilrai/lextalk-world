...
export function MumbaiAdvisoryBoard() {
    ...
    return (
        <section className="relative py-20 md:py-28 bg-[#0a0f1e] overflow-hidden">
            ...
            />
            {/* Soft glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] bg-amber-500/5 rounded-full blur-[120px]" />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 md:mb-16">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[10px] font-bold text-amber-500 uppercase tracking-[0.35em]">
                                Leadership
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => scroll("left")}
                            className="w-11 h-11 rounded-full border border-white/15 flex items-center justify-center text-white/60 hover:bg-amber-500 hover:border-amber-500 hover:text-white transition-all duration-300"
                        >
                            <ChevronLeft size={18} />
                        </button>
                        <button
                ...
                >
                    {boardMembers.map((member, idx) => (
                        ...
                        >
                            {/* Card */}
                            <div className="relative rounded-2xl overflow-hidden bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm hover:border-amber-500/30 transition-all duration-500">
                                {/* Image */}
                                <div className="relative aspect-[3/3.8] overflow-hidden">
                                    ...
                                    {member.linkedin && (
                                        <a
                                            ...
                                            className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center text-white/70 opacity-0 group-hover:opacity-100 hover:bg-amber-500 hover:text-white transition-all duration-300"
                                        >
                                            <Linkedin size={14} />
                                        </a>
                                    )}
                                ...
                                <div className="px-5 pb-5 -mt-6 relative z-10">
                                    <h3 className="text-lg font-serif font-bold text-white leading-tight mb-1 group-hover:text-amber-400 transition-colors duration-300">
                                        {member.name}
                                    </h3>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex -space-x-2">
                            {boardMembers.slice(0, 5).map((m, i) => (
                                <div
                                    key={i}
                                    className="w-8 h-8 rounded-full border-2 border-[#0a0f1e] overflow-hidden"
                                >
                                    <Image
                                        src={m.image}
                                        alt=""
