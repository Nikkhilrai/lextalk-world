...
// Same attendee personas as Bangalore but context is Mumbai
const attendees = [
    {
    ...
    return (
        <section className="relative bg-[#0a0f1e] overflow-hidden py-24 md:py-32">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 right-1/3 w-[600px] h-[600px] bg-sky-500/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-rose-500/5 rounded-full blur-[100px]" />
            </div>
