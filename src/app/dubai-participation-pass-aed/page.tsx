...
const FEATURES = [
    { icon: Star,       text: "Complete conference access" },
    { icon: Users,      text: "Networking with Global GCs and senior legal leaders" },
    { icon: LayoutGrid, text: "All conference sessions" },
    { icon: Coffee,     text: "Lunch and high tea" },
    { icon: Share2,     text: "Networking opportunities with participating firms and organisations" },
    { icon: Award,      text: "Participation certificate" },
    { icon: BookOpen,   text: "Access to Middle East LegalTech Report – Volume 2" },
    { icon: Zap,        text: "Opportunity to introduce yourself and your organisation during the Morning One-on-One Meeting Session" },
];
        ...
        try {
            const res = await fetch("/api/delegate-registration/save-lead", {
                ...
                body: JSON.stringify({
                    ...
                    passType: "exclusive-aed",
                    passCategory: "individual",
                    conferenceSlug: "dubai-2026",
                    originalPrice: PRICE_AED,
                    discountedPrice: PRICE_AED,
                }),
            });
    ...
    const handlePayment = async () => {
        ...
        try {
            const orderRes = await fetch("/api/delegate-registration/create-order", {
                ...
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    amount: PRICE_AED, currency: "AED",
                    passType: "exclusive-aed", passCategory: "individual",
                    paymentType: "uae", customerDetails: formData,
                    conferenceSlug: "dubai-2026",
                    originalPrice: PRICE_AED, discountedPrice: PRICE_AED,
                    registrationId,
                }),
            });
            ...
            const options = {
                ...
                currency: "AED",
                name: "LexTalk World",
                description: "Special Participation Rate — Dubai 2026",
                ...
                <div className="fixed inset-0 z-[100000] flex items-end sm:items-start justify-center p-0 sm:p-4 sm:pt-24 overflow-y-auto">
                    ...
                    >
                        ...
                        <div className="relative flex items-center justify-between px-6 pt-5 pb-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-amber-50/30">
                            <div>
                                <p className="text-[9px] font-black uppercase tracking-[0.25em] text-amber-600 mb-0.5">Special Participation Rate · Dubai 2026</p>
                                    ...
                                    <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
                                        <div className="p-4 bg-gradient-to-br from-slate-50 to-amber-50/30 rounded-2xl border border-slate-100">
                                            ...
                                            <div className="space-y-1.5 text-sm">
                                                {[
                                                    { label: "Pass", value: "Special Participation Rate" },
                                        ...
                                        <div className="p-4 bg-amber-50/60 border border-amber-100 rounded-2xl space-y-2">
                                            ...
                                            <div className="flex justify-between text-base font-black">
                                                ...
                                                <span className="text-slate-900">AED {PRICE_AED}</span>
                                            </div>
                                        </div>
                                        {error && (
                                            <div className="flex items-center gap-2 p-3 bg-red-50 text-red-600 text-xs rounded-xl border border-red-100">
                                        ...
                                        >
                                            ...
                                            <span className="text-2xl font-black">AED {PRICE_AED}</span>
            ...
            <div className="relative bg-gradient-to-b from-[#0d1a2e] to-[#0f172a] rounded-3xl overflow-hidden border border-amber-500/20 shadow-2xl">
                ...
                <div className="p-6">
                    ...
                    <div className="mb-6 p-4 rounded-2xl bg-gradient-to-br from-amber-500/8 to-amber-400/4 border border-amber-500/15">
                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-amber-500/60 mb-2">Special Rate · Both Days</p>
                        <div className="flex items-end gap-2">
                            <span className="text-5xl font-black text-white leading-none">{PRICE_AED}</span>
                            <span className="text-slate-400 text-sm mb-1">AED</span>
                        </div>
                ...
                <div className="container mx-auto px-4 max-w-6xl relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                        ...
                        <div className="lg:pt-6">
                            ...
                            >
                                Special participation rate of AED 730 for both days of LexTalk World Dubai 2026 — complete conference access, networking with Global GCs and senior legal leaders, and the Middle East LegalTech Report Volume 2.
                            </motion.p>
