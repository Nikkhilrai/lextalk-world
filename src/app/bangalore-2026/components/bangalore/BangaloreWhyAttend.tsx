...
export function BangaloreWhyAttend() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24 max-w-7xl mx-auto">
                    ...
                    <div className="text-center lg:text-left">
                        <div className="inline-flex items-center gap-3 mb-6">
                            ...
                            <span className="text-xs font-bold text-amber-600 uppercase tracking-[0.3em]">The Bangalore Summit</span>
                        </div>
                        ...
                        <div className="relative">
                            <p className="text-slate-600 text-lg md:text-xl leading-[1.8] font-light max-w-xl">
                                ...
                                Join the region's largest gathering of legal and tech leaders. LexTalk World Bangalore is the definitive platform where strategy meets execution in the heart of India's technology capital.
                            </p>
                        </div>
                    </div>
