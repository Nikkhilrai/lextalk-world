...
const upcomingConferences = [
    {
        ...
        description: "Join 500+ legal leaders for two days of insights, networking, and innovation at the heart of the UAE. Experience world-class speakers, cutting-edge legal tech showcases, and unparalleled networking opportunities.",
        highlights: [
            "Keynote sessions from global legal leaders",
            "AI & Legal Tech Innovation Showcase",
    ...
    },
    {
        ...
        highlights: [
            "India's largest legal networking event",
            "Cross-border legal practice insights",
                                        ...
                                        <div className="grid grid-cols-4 gap-4 mb-8 p-4 bg-slate-50 rounded-xl">
                                            {Object.entries(event.stats).map(([key, value], i) => (
                                                <div key={i} className="text-center">
                                                    ...
                                                    <div className="text-[10px] md:text-xs text-slate-500 uppercase tracking-wider capitalize">{key}</div>
                                                </div>
                                            ))}
                                        </div>
