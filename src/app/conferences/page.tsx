...
const upcomingConferences = [
    {
        ...
        description: "Join 800+ legal leaders for two days of insights, networking, and innovation at the heart of the UAE. Experience world-class speakers, cutting-edge legal tech showcases, and unparalleled networking opportunities.",
        highlights: [
