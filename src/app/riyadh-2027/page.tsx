...
/**
 * Riyadh 2027 — announcement page.
 *
 * Phase 1 of the Riyadh build: a shareable URL for sponsor and speaker outreach while
 * venue, speakers and sponsors are still being confirmed. Modelled on delhi-2027, the
 * existing "coming soon" pattern.
 *
 * Deliberately omits the commercial figures from the operational plan (delegate pricing,
 * sponsorship tiers, attendance targets) — those are sales-deck numbers, not public
 * announcement content, and several are still moving.
 *
 * The conference string passed to RegisterModal must byte-match the entry in that
 * component's hardcoded radio list, which is compared by exact equality.
 */
export default function Riyadh2027Page() {
    ...
    return (
        <main className="min-h-screen bg-[#050a15]">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-20">
                ...
                <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
                    ...
                    <motion.p
                        ...
                        className="text-white/90 font-serif text-lg md:text-2xl max-w-3xl leading-snug mb-5 italic"
                    >
                        Operationalizing AI, Cyber Resilience &amp; Data Privacy
                    </motion.p>
                    ...
                    >
                        A one-day executive summit bringing General Counsel, CISOs and Chief Privacy
                        Officers together in Saudi Arabia. Venue, speakers and the full programme will
                        be announced soon.
                    </motion.p>
                    ...
                    >
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
                            ...
                            <span className="text-slate-300 text-xs font-semibold tracking-wide">Tuesday, 26 January 2027</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
                            <MapPin className="w-3.5 h-3.5 text-amber-500/70" />
                            <span className="text-slate-300 text-xs font-semibold tracking-wide">Riyadh, Saudi Arabia</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.06] rounded-full">
            ...
            <RegisterModal
                ...
                defaultConference="Riyadh KSA, Jan 26 2027"
            />
        </main>
    );
}
