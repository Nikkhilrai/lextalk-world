 ...
 *
 * The chat widget and the homepage's auto-opening "Register Your Interest" modal
 * are mounted as siblings in the root layout with no common ancestor holding
 * state, and both are lead-capture surfaces that would otherwise cover each
 * other — the homepage auto-opens the register modal 8s after load, right on
 * top of an open chat panel.
 *
