// Comprehensive country data with ISO codes, dial codes, and flag emojis
...
// Default country (India for this site)
export const DEFAULT_COUNTRY = COUNTRIES_DATA.find(c => c.code === "IN")!;
